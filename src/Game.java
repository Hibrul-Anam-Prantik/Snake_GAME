...
public class Game extends JPanel implements ActionListener {
    ...
    private final int DELAY = 100;  // Timer delay (lower = faster)
            ...
            */
            ...
            for (int i = 0; i < bodyParts; i++) {
                if (i == 0) {
                    ...
                    // This is a valid Java source file without Markdown code fences
    ...
    public void gameOver(Graphics g) {
        ...
        String scoreText = "Score: " + applesEaten;
        g.drawString(scoreText, (WIDTH - metrics1.stringWidth(scoreText)) / 2, g.getFont().getSize());
        ...
        g.drawString(restartText, (WIDTH - metrics3.stringWidth(restartText)) / 2, HEIGHT / 2 + 50);
    }
    ...
    public static void main(String[] args) {
        ...
        frame.setTitle("Snake Game by Prantik");
        frame.pack();
